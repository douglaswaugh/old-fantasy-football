    ...
    public class FileTeamProviderTests
    {
        ...
        public void PopulateTeam()
        {
            ...
            deserialiser.Deserialise("playerData")
                .Returns(new Player(508, "Al Habsi", new GoalkeeperPointsCalculator(), new FixtureHistory(new List<PlayerFixture>())));
            ...
            var alHabsi = new Player(508, "Al Habsi", new GoalkeeperPointsCalculator(), new FixtureHistory(new List<PlayerFixture>()));
